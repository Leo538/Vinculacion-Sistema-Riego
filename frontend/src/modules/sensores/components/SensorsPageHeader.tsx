  ...
  return (
    <header className="flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-[#CBDDF5] pb-2 dark:border-slate-700/40">
      <div className="min-w-0">
        <h1 className="text-sm font-semibold text-slate-900 dark:text-white">Sensores</h1>
        <p className="text-[10px] text-slate-500">Monitoreo en tiempo real de variables del sistema de riego</p>
      </div>
